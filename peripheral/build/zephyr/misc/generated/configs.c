...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_NRF21540EK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LOG_LEVEL_OFF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_FILE_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_FS_FILES_LIMIT, 256);
